...
| Node            |  name   |   id    |  code   | description  |  note   |  rule   | branch  |  unit   |  party  | employee  | date_time |  color  |     first      |   second    | discount  | locked  | initial_total | final_total |
| --------------- | :-----: | :-----: | :-----: | :----------: | :-----: | :-----: | :-----: | :-----: | :-----: | :-------: | :-------: | :-----: | :------------: | :---------: | :-------: | :-----: | :-----------: | :---------: |
| EnumSearch      |  kName  |   kID   |  kCode  | kDescription |  kNote  |  kRule  | kBranch |  kUnit  | kParty  | kEmployee | kDateTime | KColor  |     kFirst     |   kSecond   | kDiscount | kLocked | kInitialTotal | kFinalTotal |
|                 |         |         |         |              |         |         |         |         |         |           |           |         |                |             |           |         |               |             |
| Qt              | QString |   int   | QString |   QString    | QString |  bool   |  bool   |   int   |   int   |    int    |  QString  | QString |     double     |   double    |  double   |  bool   |    double     |   double    |
| Sqlite3         |  TEXT   | INTEGER |  TEXT   |     TEXT     |  TEXT   | BOOLEAN | BOOLEAN | INTEGER | INTEGER |  INTEGER  |   DATE    |  TEXT   |    NUMERIC     |   NUMERIC   |  NUMERIC  | BOOLEAN |    NUMERIC    |   NUMERIC   |
|                 |         |         |         |              |         |         |         |         |         |           |           |         |                |             |           |         |               |             |
| finance         |  name   |   id    |  code   | description  |  note   |  rule   | branch  |  unit   |    X    |     X     |     X     |    X    |       X        |      X      |     X     |    X    | initial_total | final_total |
| TreeEnum        |  kName  |   kID   |  kCode  | kDescription |  kNote  |  kRule  | kBranch |  kUnit  |    X    |     X     |     X     |    X    |       X        |      X      |     X     |    X    | kInitialTotal | kFinalTotal |
|                 |         |         |         |              |         |         |         |         |         |           |           |         |                |             |           |         |               |             |
| task            |  name   |   id    |  code   | description  |  note   |  rule   | branch  |  unit   |    X    |     X     | date_time |  color  |   unit_cost    |      X      |     X     |    X    | initial_total | final_total |
| TreeEnumTask    |  kName  |   kID   |  kCode  | kDescription |  kNote  |  kRule  | kBranch |  kUnit  |    X    |     X     | kDateTime | kColor  |   kUnitCost    |      X      |     X     |    X    | kInitialTotal | kFinalTotal |
|                 |         |         |         |              |         |         |         |         |         |           |           |         |                |             |           |         |               |             |
| product         |  name   |   id    |  code   | description  |  note   |  rule   | branch  |  unit   |    X    |     X     |     X     |  color  |   unit_price   | commission  |     X     |    X    | initial_total | final_total |
| EnumProduct     |  kName  |   kID   |  kCode  | kDescription |  kNote  |  kRule  | kBranch |  kUnit  |    X    |     X     |     X     | kColor  |   kUnitPrice   | kCommission |     X     |    X    | kInitialTotal | kFinalTotal |
|                 |         |         |         |              |         |         |         |         |         |           |           |         |                |             |           |         |               |             |
| stakeholder     |  name   |   id    |  code   | description  |  note   |  rule   | branch  |  unit   |    X    | employee  | deadline  |    X    | payment_period |  tax_rate   |     X     |    X    |       X       |      X      |
| EnumStakeholder |  kName  |   kID   |  kCode  | kDescription |  kNote  |  kRule  | kBranch |  kUnit  |    X    | kEmployee | kDeadline |    X    | kPaymentPeriod |  kTaxRate   |     X     |    X    |       X       |      X      |
|                 |         |         |         |              |         |         |         |         |         |           |           |         |                |             |           |         |               |             |
| purchase        |  name   |   id    |  code   | description  |  note   |  rule   | branch  |  unit   |  party  | employee  | date_time |    X    |     first      |   second    | discount  | locked  |    amount     |   settled   |
| EnumOrder       |  kName  |   kID   |  kCode  | kDescription |  kNote  |  kRule  | kBranch |  kUnit  | kParty  | kEmployee | kDateTime |    X    |     kFirst     |   kSecond   | kDiscount | kLocked |    kAmount    |  kSettled   |
|                 |         |         |         |              |         |         |         |         |         |           |           |         |                |             |           |         |               |             |
| sales           |  name   |   id    |  code   | description  |  note   |  rule   | branch  |  unit   |  party  | employee  | date_time |    X    |     first      |   second    | discount  | locked  |    amount     |   settled   |
| EnumOrder       |  kName  |   kID   |  kCode  | kDescription |  kNote  |  kRule  | kBranch |  kUnit  | kParty  | kEmployee | kDateTime |    X    |     kFirst     |   kSecond   | kDiscount | kLocked |    kAmount    |  kSettled   |
...
| TableEnum       |   kID   | kDateTime |  kCode  |       X        |     X     |  kDebit   |  kCredit   | kDescription | kLhsRatio  |      X      |       X        |    X     |  kDocument  | kState  |     X      |     X     |     X     |    kRhsNode     |
|                 |         |           |         |                |           |           |            |              |            |             |                |          |             |         |            |           |           |                 |
| stakeholder     |   id    | date_time |  code   | inside_product |     X     |     X     |     X      | description  | unit_price | helper_node |       X        |    X     |  document   |  state  |     X      |     X     |     X     | outside_product |
| EnumStakeholder |   kID   | kDateTime |  kCode  | kInsideProduct |     X     |     X     |     X      | kDescription | kUnitPrice |      X      |       X        |    X     |  kDocument  | kState  |     X      |     X     |     X     | kOutsideProduct |
|                 |         |           |         |                |           |           |            |              |            |             |                |          |             |         |            |           |           |                 |
| purchase        |   id    |     X     |  code   | inside_product |     X     |   first   |   second   | description  | unit_price | helper_node | discount_price | settled  |      X      |    X    |   amount   | discount  |     X     | outside_product |
| EnumOrder       |   kID   |     X     |  kCode  | kInsideProduct |     X     |  kFirst   |  kSecond   | kDescription | kUnitPrice |      X      | kDiscountPrice | kSettled |      X      |    X    |  kAmount   | kDiscount |     X     | kOutsideProduct |
|                 |         |           |         |                |           |           |            |              |            |             |                |          |             |         |            |           |           |                 |
| sales           |   id    |     X     |  code   | inside_product |     X     |   first   |   second   | description  | unit_price | helper_node | discount_price | settled  |      X      |    X    |   amount   | discount  |     X     | outside_product |
| EnumOrder       |   kID   |     X     |  kCode  | kInsideProduct |     X     |  kFirst   |  kSecond   | kDescription | kUnitPrice |      X      | kDiscountPrice | kSettled |      X      |    X    |  kAmount   | kDiscount |     X     | kOutsideProduct |
