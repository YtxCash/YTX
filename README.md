...
|                 |         |         |         |              |         |           |         |         |         |           |           |                |             |           |         |               |             |
| task            |  name   |   id    |  code   | description  |  note   | node_rule | branch  |  unit   |    X    |     X     |   color   |   unit_cost    |      X      |     X     |    X    | initial_total | final_total |
| TreeEnumTask    |  kName  |   kID   |  kCode  | kDescription |  kNote  |   kRule   | kBranch |  kUnit  |    X    |     X     |  kColor   |   kUnitCost    |      X      |     X     |    X    | kInitialTotal | kFinalTotal |
|                 |         |         |         |              |         |           |         |         |         |           |           |                |             |           |         |               |             |
...
| EnumStakeholder |  kName  |   kID   |  kCode  | kDescription |  kNote  |   kRule   | kBranch |  kUnit  |    X    | kEmployee | kDeadline | kPaymentPeriod |  kTaxRate   |     X     |    X    |       X       |      X      |
|                 |         |         |         |              |         |           |         |         |         |           |           |                |             |           |         |               |             |
