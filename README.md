...
| --------------- | :-----: | :-----: | :-----: | :----------: | :-----: | :-------: | :-----: | :-----: | :-----: | :-------: | :-------: | :-----: | :------------: | :---------: | :-------: | :-----: | :-----------: | :---------: |
| EnumOrder       |  kName  |   kID   |  kCode  | kDescription |  kNote  |   kRule   | kBranch |  kUnit  | kParty  | kEmployee | kDateTime | KColor  |     kFirst     |   kSecond   | kDiscount | kLocked | kInitialTotal | kFinalTotal |
|                 |         |         |         |              |         |           |         |         |         |           |           |         |                |             |           |         |               |             |
...
|                 |         |         |         |              |         |           |         |         |         |           |           |         |                |             |           |         |               |             |
| finance         |  name   |   id    |  code   | description  |  note   | node_rule | branch  |  unit   |    X    |     X     |     X     |    X    |       X        |      X      |     X     |    X    | initial_total | final_total |
| TreeEnum        |  kName  |   kID   |  kCode  | kDescription |  kNote  |   kRule   | kBranch |  kUnit  |    X    |     X     |     X     |    X    |       X        |      X      |     X     |    X    | kInitialTotal | kFinalTotal |
|                 |         |         |         |              |         |           |         |         |         |           |           |         |                |             |           |         |               |             |
| task            |  name   |   id    |  code   | description  |  note   | node_rule | branch  |  unit   |    X    |     X     | date_time |  color  |   unit_cost    |      X      |     X     |    X    | initial_total | final_total |
...
|                 |         |         |         |              |         |           |         |         |         |           |           |         |                |             |           |         |               |             |
| product         |  name   |   id    |  code   | description  |  note   | node_rule | branch  |  unit   |    X    |     X     |     X     |  color  |   unit_price   | commission  |     X     |    X    | initial_total | final_total |
...
|                 |         |         |         |              |         |           |         |         |         |           |           |         |                |             |           |         |               |             |
| stakeholder     |  name   |   id    |  code   | description  |  note   | node_rule | branch  |  unit   |    X    | employee  | deadline  |    X    | payment_period |  tax_rate   |     X     |    X    |       X       |      X      |
...
|                 |         |         |         |              |         |           |         |         |         |           |           |         |                |             |           |         |               |             |
| purchase        |  name   |   id    |  code   | description  |  note   | node_rule | branch  |  unit   |  party  | employee  | date_time |    X    |     first      |   second    | discount  | locked  |    amount     |   settled   |
...
|                 |         |         |         |              |         |           |         |         |         |           |           |         |                |             |           |         |               |             |
| sales           |  name   |   id    |  code   | description  |  note   | node_rule | branch  |  unit   |  party  | employee  | date_time |    X    |     first      |   second    | discount  | locked  |    amount     |   settled   |
| EnumOrder       |  kName  |   kID   |  kCode  | kDescription |  kNote  |   kRule   | kBranch |  kUnit  | kParty  | kEmployee | kDateTime |    X    |     kFirst     |   kSecond   | kDiscount | kLocked |    kAmount    |  kSettled   |
...
| TableEnum       |   kID   | kDateTime |  kCode  |       X        |     X     |  kDebit   |  kCredit   | kDescription | kLhsRatio  |    X     |       X        |    X     |  kDocument  | kState  |     X      |     X     |     X     |    kRhsNode     |
|                 |         |           |         |                |           |           |            |              |            |          |                |          |             |         |            |           |           |                 |
| stakeholder     |   id    | date_time |  code   | inside_product |     X     |     X     |     X      | description  | unit_price | node_id  |       X        |    X     |  document   |  state  |     X      |     X     |     X     | outside_product |
