...
| TableEnum       |   kID   | kDateTime |  kCode  |        X        |     X     |  kDebit   |  kCredit   | kDescription | kLhsRatio  |    X     |       X        |    X     |  kDocument  | kState  |     X      |     X     |     X     |    kRhsNode     |
|                 |         |           |         |                 |           |           |            |              |            |          |                |          |             |         |            |           |           |                 |
| stakeholder     |   id    | date_time |  code   | outside_product |     X     |     X     |     X      | description  | unit_price | node_id  |       X        |    X     |  document   |  state  |     X      |     X     |     X     | inside_product  |
| EnumStakeholder |   kID   | kDateTime |  kCode  | kOutsideProduct |     X     |     X     |     X      | kDescription | kUnitPrice |    X     |       X        |    X     |  kDocument  | kState  |     X      |     X     |     X     | kInsideProduct  |
|                 |         |           |         |                 |           |           |            |              |            |          |                |          |             |         |            |           |           |                 |
