...
|                 |         |         |         |              |         |         |         |         |         |           |           |         |                |             |           |           |               |             |
| finance         |  name   |   id    |  code   | description  |  note   |  rule   | branch  |  unit   |    X    |     X     |     X     |    X    |       X        |      X      |     X     | is_helper | initial_total | final_total |
| TreeEnum        |  kName  |   kID   |  kCode  | kDescription |  kNote  |  kRule  | kBranch |  kUnit  |    X    |     X     |     X     |    X    |       X        |      X      |     X     | kIsHelper | kInitialTotal | kFinalTotal |
|                 |         |         |         |              |         |         |         |         |         |           |           |         |                |             |           |           |               |             |
| task            |  name   |   id    |  code   | description  |  note   |  rule   | branch  |  unit   |    X    |     X     | date_time |  color  |   unit_cost    |      X      |     X     | is_helper | initial_total | final_total |
| TreeEnumTask    |  kName  |   kID   |  kCode  | kDescription |  kNote  |  kRule  | kBranch |  kUnit  |    X    |     X     | kDateTime | kColor  |   kUnitCost    |      X      |     X     | kIsHelper | kInitialTotal | kFinalTotal |
|                 |         |         |         |              |         |         |         |         |         |           |           |         |                |             |           |           |               |             |
...
|                 |         |         |         |              |         |         |         |         |         |           |           |         |                |             |           |           |               |             |
| stakeholder     |  name   |   id    |  code   | description  |  note   |  rule   | branch  |  unit   |    X    | employee  | deadline  |    X    | payment_period |  tax_rate   |     X     | is_helper |       X       |      X      |
| EnumStakeholder |  kName  |   kID   |  kCode  | kDescription |  kNote  |  kRule  | kBranch |  kUnit  |    X    | kEmployee | kDeadline |    X    | kPaymentPeriod |  kTaxRate   |     X     | kIsHelper |       X       |      X      |
|                 |         |         |         |              |         |         |         |         |         |           |           |         |                |             |           |           |               |             |
...
| TableEnum       |   kID   | kDateTime |  kCode  |    X     |     X     |  kDebit   |  kCredit   | kDescription | kLhsRatio  |   kHelperNode   |       X        |    X     |  kDocument  | kState  |     X      |     X     |     X     |    kRhsNode    |
|                 |         |           |         |          |           |           |            |              |            |                 |                |          |             |         |            |           |           |                |
