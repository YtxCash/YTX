...
struct NodeShadow {
    ...
    NodeShadow& operator=(Node* other);
    void Reset();

    NodeShadow(NodeShadow&&) noexcept = delete;
    NodeShadow& operator=(NodeShadow&&) noexcept = delete;
    NodeShadow(Node* other) = delete;
...
inline NodeShadow& NodeShadow::operator=(Node* other)
{
    if (!other) {
        Reset();
        return *this;
