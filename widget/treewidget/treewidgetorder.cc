...
void TreeWidgetOrder::SetStatus()
{
...
void TreeWidgetOrder::DynamicStatus(int lhs_node_id, int rhs_node_id)
{
...
void TreeWidgetOrder::StaticStatus(int node_id) { ui->dspin_box_static_->setValue(model_->InitialTotal(node_id)); }
